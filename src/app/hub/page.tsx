            ...
            return (
              ...
              >
                <Link href={hub.href} className="block h-full group">
                  <div
                    className="relative rounded-3xl overflow-hidden cursor-pointer h-full transition-all duration-500"
                    style={{
                      boxShadow: `0 4px 20px -4px ${hub.glow}, 0 2px 8px -2px rgba(0,0,0,0.1)`,
                    }}
                  >
